window.app = {
	 ...
	 * netty服务后端发布的地址
	 */
	nettyServerUrl: 'ws://192.168.123.240/ws',
	// nettyServerUrl: 'ws://192.168.123.227:8088/ws',
	
	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: 'http://192.168.123.240:8080/changliao',
	
	/**
	 * 图片服务的url
	 */
	imgServerUrl: 'http://192.168.123.240:89/changliao/',
	...
	getUserGlobalInfo: function (){
		var userInfoStr = plus.storage.getItem("userInfo", userInfoStr);
	...
	saveUserChatSnapshot: function(myId, friendId, msg, isRead){
		...
		if(me.isNotNull(chatSnapshotListStr)){
			...
			// 循环快照list, 并且判断每个元素是否包含（匹配）friendId， 如果匹配
